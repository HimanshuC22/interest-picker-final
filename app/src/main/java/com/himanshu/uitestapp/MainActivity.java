...
//        recyclerView.addItemDecoration(new SpaceItemDecoration(10));
        ...
        InterestAdapter interestAdapter = new InterestAdapter(MainActivity.this, subInterestList);
        //recyclerView.setAdapter(interestAdapter);
        //InterestAdapter interestAdapter = new InterestAdapter(this, subMultiArray[mainPos]);
        int[] arr = {0, 0, 0};
        InterestGridAdapter interestGridAdapter = new InterestGridAdapter(MainActivity.this, subMultiArray[mainPos], arr);
